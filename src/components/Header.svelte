...
<header class="text-gray-600 sticky top-0 bg-white body-font">
  <div class="container mx-auto flex flex-wrap p-2 flex-col md:flex-row items-center">
   ...
   <a  href="/" class="mr-5 cursor-pointer hover:text-gray-900">CSAT Notes</a>
      <a  href="/"  class="mr-5 cursor-pointer hover:text-gray-900">Polity Notes</a>
      <a href="/"  class="mr-5 cursor-pointer hover:text-gray-900">Economics Notes</a>
      <a  href="/" class="mr-5 cursor-pointer hover:text-gray-900">Fourth Link</a>
    </nav> -->
